        ...
        <div className="holographic-border rounded-2xl p-8 relative">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="link-futuristic text-sm">
                Forgot Password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              className="submit-button w-full py-4 rounded-lg text-black font-bold text-base transition-all duration-300 flex items-center justify-center space-x-2"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-cyan-300/60 text-sm">
              ...
              <Link to="/signup" className="link-futuristic">
                Sign Up
              </Link>
            </p>
          </div>
          ...
          <div className="mt-4 text-center">
            <Link to="/admin/login" className="link-futuristic text-xs">
              Admin Login →
            </Link>
          </div>
        </div>
